                                            ...
                                            <table className="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-center"><img src={givenImage} style={{ height: '40px', width: '40px', borderRadius: '50%' }} className="img-avatar img-thumbnail p-0 border-2" alt="user_avatar" /></td>
                                                        <td>Shelo Mora Paglinawan</td>
                                                        <td><p className="m-0 truncate-1">username</p></td>
                                                        <td><p className="m-0">user type</p></td>
                                                        <td align="center">
                                                            <button type="button" className="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                                Action
                                                                <span className="sr-only">Toggle Dropdown</span>
                                                            ...
                                                            <div className="dropdown-menu" role="menu">
                                                                <a className="dropdown-item" href="#" onClick={() => setIsEditUser(true)}><span className="fa fa-edit text-primary" /> Edit</a>
                                                                <div className="dropdown-divider" />
                ...
                <div className="popup">
                    <div className="popup-body student-body" onClick={(e) => e.stopPropagation()} style={{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)', borderRadius: '5px', animation: isDelete ? 'animateCenter 0.3s linear' : 'closeAnimateCenter 0.3s linear' }}>
                        ...
                        <div className='form-div'>
                            <span>Are you sure you wan't to Delete SHelo Mora Paglinawan?</span>
                        </div>
